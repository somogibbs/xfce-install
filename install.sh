!#/bin/bash
#Packages to install
sudo apt install blueman synaptic package-update-indicator gnome-disk-utility gparted gsmartcontrol hardinfo doublecmd-gtk pdfarranger onboard bleachbit diskscan wireshark guymager uget
